...
function OnGUI(){
	...
	if(micIn){
		if(!Microphone.IsRecording(deviceName)){
			if(GUI.Button(Rect ( 110, (buttonHeight)+10 , buttonWidth, buttonHeight), "Record black")){
				registerAudio();
			}
		}else{
			if(GUI.Button(Rect ( 110, (buttonHeight)+10 , buttonWidth, buttonHeight), "Stop Recording")){
				stopRecording();
			}
		}
		...
		if(Microphone.IsRecording(deviceName)){
			GUI.Label(Rect(buttonWidth +150, 10, buttonWidth, buttonHeight), "Recording");
		}else{
			GUI.Label(Rect(buttonWidth +150, 10, buttonWidth, buttonHeight), "Not Recording");
		}
	}
}